...
import com.nzhk.miniapp.business.wxuser.vo.WxLoginResVO;
import com.nzhk.miniapp.common.cache.ContextCache;
import com.nzhk.miniapp.common.cache.UserInfo;
import com.nzhk.miniapp.common.exception.BizException;
import com.nzhk.miniapp.common.utils.BeanConvertUtil;
import com.nzhk.miniapp.common.utils.IdUtil;
import com.nzhk.miniapp.common.utils.JwtUtil;
import com.nzhk.miniapp.mapper.WxUserMapper;
import com.nzhk.miniapp.wechat.config.WechatProperties;
        ...
        if (wxUser == null) {
            ...
            if (StringUtils.isEmpty(userId)) {
                ...
                if (existUser == null) {
                    ...
                    u.eq(WxUser::getId, userId).set(WxUser::getOpenid, openId).set(WxUser::getSessionKey, sessionKey).set(WxUser::getUpdateTime, LocalDateTime.now());
